...
export const Topbar: React.FC = () => {
    const { user, currentCompany, mode, exitImpersonation, setIsSigningOut, resetState } = useAuth(); // ✅ Agregar resetState
    ...
    const handleLogout = async () => {
        ...
        try {
            ...
            // 🔧 FIX: Forzar resetState() por si SIGNED_OUT no se emite
