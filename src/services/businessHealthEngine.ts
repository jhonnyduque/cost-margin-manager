...
export function runHealthCheck(input: HealthCheckInput): HealthReport {
    const { products, rawMaterials, batches, movements, productMovements, unitsOfMeasure } = input;

    const signals: RiskSignal[] = [
        ...detectDebt(movements, rawMaterials, batches),
        ...detectPriceBelowCost(products, batches, rawMaterials, productMovements, unitsOfMeasure),
        ...detectMarginDrift(products, batches, rawMaterials, productMovements, unitsOfMeasure),
    ...
    const kpis = buildKPIs(products, batches, rawMaterials, movements, unitsOfMeasure);
